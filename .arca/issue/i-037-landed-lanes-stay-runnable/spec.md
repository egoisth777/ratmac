...
Billy. None of the three asks presumes an Engine feature: the sweep and its
marker are shop-lane tooling and records, and the close wiring is a runbook
guard the existing vocabulary already expresses. The marker-home, schedule,
and sweep-owner choices were decided in the same pass and are recorded in
the goal design
([ADR-0020](../../goal/design.md#landed-lanes-sweep-on-demand-and-expire-by-in-crate-marker-adr-0020)).
