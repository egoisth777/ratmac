...
| Spawn ledger | The per-run record of spawned children. Its on-disk location (a name under the run's directory) is reserved by run residency ([i-017 spec.md](../i-017-run-residency/spec.md), `FDC-004`); its contract - contents, when written, meaning - is defined here (scope settled 2026-07-29, accepted review fix), condensed from `.arca/research/re-ratmac-FSM/05-invocation-join.md` ("The spawn ledger"). |
