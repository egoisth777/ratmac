...
| :--- | :--- | :--- | :--- | :--- |
| `PCR-001` | `.arca/ratmac.toml` declares the P1-P5 cycle this repository runs — its Phases, prompts, and Exit Guards over `.arca/` — replacing the demonstration machine. | deferred | The real cycle depends on routing, delivery, completion, and composition contracts not all integrated in this pass. | — (deferred 2026-07-30) |
