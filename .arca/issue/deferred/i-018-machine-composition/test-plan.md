...
| :--- | :--- | :--- |
| MCV-001 | FDC-007 - FDC-010 | Every ask traces to its decision record in the seed's design ([design.md](../../archive/i-016-fsm-doctrine-convergence/design.md) - Adopted defaults for FDC-007, FDC-008, FDC-010; Individual human rulings for FDC-009) and to the research sections it condenses (`.arca/research/re-ratmac-FSM/05-invocation-join.md`, `07-conceptual-model.md`). |
