...
- Independent of the input-routed-transition issue ([i-016-fsm-doctrine-convergence](../../archive/i-016-fsm-doctrine-convergence/spec.md)) and input-delivery issue ([i-019-input-delivery-durability](../../archive/i-019-input-delivery-durability/spec.md)).
