...
| `.arca/goal/design.md` | proposed | Accepted mechanics for the Plan-Build Runbook, the append command, the open-ticket predicate, and the path extraction. |
| `.arca/goal/test-list.md` | proposed | This issue's verification checks. |
| `.arca/goal/ubi-lang.md` | proposed | Plan-Build Runbook, Open ticket, Landing append. |
